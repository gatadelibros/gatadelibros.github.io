    ...
    R = {
      ...
      getPathValues: function() {
        var e = J.location.pathname
            .slice(1)
            .split("https://www.beingeorge.com/")
            .filter(function(e) {
              return "" !== e;
            }),
          t = e.length;
...
!(function(t, e, i) {
  ...
  (s.prototype = {
    _init: function() {
      ...
      i._setVars(),
        ...
        i.supported &&
          setTimeout(function() {
            i._setTransitions(),
              (i.$container[0].style[i.transitionName] =
                "height " + i.speed + "ms " + i.easing);
          }, 0);
    },
    _addClasses: function() {
      var t = this;
      return (
        t.$container.addClass("shuffle"),
    ...
    _setSequentialDelay: function(e) {
      ...
      i.supported &&
        t.each(e, function(e) {
          (this.style[i.transitionDelayName] =
            "0ms," + (e + 1) * i.sequentialFadeDelay + "ms"),
    ...
    _getPreciseDimension: function(e, i) {
      ...
      return (
        (n = window.getComputedStyle
          ? window.getComputedStyle(e, null)[i]
          : t(e).css(i)),
        parseFloat(n)
      );
    },
    ...
    _placeItem: function(t, e, i, n, s) {
      for (
        var r = this, o = Math.min.apply(Math, e), a = 0, l = 0, u = e.length;
        u > l;
        l++
      )
